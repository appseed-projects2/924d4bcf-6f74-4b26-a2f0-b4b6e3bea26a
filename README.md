...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-09-06 05:32`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/924d4bcf-6f74-4b26-a2f0-b4b6e3bea26a.git
$ cd 924d4bcf-6f74-4b26-a2f0-b4b6e3bea26a
```
